...
if (!class_exists('NimblePortfolioRecentItemsWidget')) {
    ...
    class NimblePortfolioRecentItemsWidget extends WP_Widget {
        ...
        function NimblePortfolioRecentItemsWidget() {
            $widget_ops = array('classname' => 'nimble-portfolio-recent-items-widget', 'description' => __('Display recent portfolio items in List style','nimble_portfolio'));
            $control_ops = array('width' => 250, 'height' => 250, 'id_base' => 'nimble-portfolio-recent-items-widget');
            parent::__construct('nimble-portfolio-recent-items-widget', __('Nimble Portfolio &mdash; Recent Items','nimble_portfolio'), $widget_ops, $control_ops);
        }
