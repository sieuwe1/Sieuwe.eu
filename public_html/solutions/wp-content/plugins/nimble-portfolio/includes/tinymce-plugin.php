...
<html>
    <head>
        <title><?php _e('Nimble Portfolio Shortcode','nimble_portfolio'); ?></title>
...
jQuery(document).ready(function($){
    ...
    <body>
        ...
        <p><button onclick="javascript:NimblePortfolio.insert(NimblePortfolio.e)"><?php _e('Insert Shortcode','nimble_portfolio'); ?></button></p>
    </body>
</html>
