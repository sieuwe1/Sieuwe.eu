...
if (!class_exists('NimblePortfolio')) {
    ...
    class NimblePortfolio {
        ...
        function renderTemplate() {
            ...
            ?>
            <div class="nimble-portfolio <?php echo $loader_flag ? "-isloading" : ""; ?> <?php echo apply_filters("nimble_portfolio_skin_classes", "-skin-$this->skin", $this); ?>" id="<?php echo $this->ID; ?>" data-lightbox="<?php echo isset($this->atts['lightbox']) && $this->atts['lightbox'] ? $this->atts['lightbox'] : 'prettyphoto' ; ?>">

                <?php if ($loader_flag) { ?>
                    <div class="-loading"><div class="-loader"><?php _e('Loading...','nimble_portfolio'); ?></div></div>
                <?php } ?>
                ...
                <?php if (!$this->atts['hide_filters']) { ?>
                    <div class="-filters <?php echo apply_filters("nimble_portfolio_skin_filters_classes", "", $this); ?>">
                        <?php echo apply_filters('nimble_portfolio_filter_all', sprintf('<a href="#" data-rel="*" class="-filter active">%s</a>', __("All", "nimble_portfolio"))); ?>
        ...
        function getFilters($args = array()) {
            ...
            $args['taxonomy'] = isset($args['taxonomy']) ? $args['taxonomy'] : $this->taxonomy;
