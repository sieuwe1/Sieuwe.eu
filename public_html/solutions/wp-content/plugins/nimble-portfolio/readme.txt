...
> We are proud to release <strong>Version 3.0.0</strong> after receiving an overwhelming response from our customers. The new version includes several new improvements as below.
> <ol>
> <li>Default Skin is upgraded with pro features. (Premium Default+ Skin becomes Default skin)
> <ul><li>Selected Filters.</li><li>Separate Gallery for item (Album) feature.</li><li>Pagination support.</li></ul></li>
> <li>PrettyPhoto Lightbox is upgraded with pro features. (Premium PrettyPhoto Lightbox becomes Default lightbox)
> <ul><li><a href="http://www.addthis.com/">Addthis</a> Social widget support.</li><li>PrettyPhoto Customization via Options.</li></ul></li>
...
1. Support for all post types and taxonomies, like Posts, Woo commerce Products e.t.c.
...
* [Seamless Premium Skin](http://www.nimble3.com/shop/premium-seamless-skin-for-nimble-portfolio/)
...
* PHP 5.3 onwards (including PHP 7)
* MySQL 5.6 onwards
...
3. Nimble Portfolio - Options and Separate Gallery meta boxes on Add New Item page
...
9. Nimble Portfolio - Global Settings
10. Nimble Portfolio - prettyPhoto Settings
...
FIXED: Redux framework color picker control incompatibility issue.
FIXED: W3C compatibility on items.php of default skin.

= 20 Sep 2017 =

3.0.0

Major upgrade, alot of new features.
...
You might need to update your default skin and prettyphoto configurations, as pro features are added to the default skin.
