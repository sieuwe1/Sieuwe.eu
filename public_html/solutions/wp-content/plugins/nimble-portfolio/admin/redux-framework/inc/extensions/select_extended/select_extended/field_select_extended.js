...
(function( $ ) {
    ...
    redux.field_objects.select_extended = redux.field_objects.select_extended || {};

    redux.field_objects.select_extended.init = function( selector ) {
        if ( !selector ) {
            selector = $( document ).find( '.redux-container-select_extended:visible' );
        }
